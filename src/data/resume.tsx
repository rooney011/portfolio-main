...
export const DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      active: true,
      description:
        "An AI-powered multi-tenant SaaS workspace that lets organizations ingest private knowledge (files + web scrapes) and query it through a streaming RAG chat interface, with hard tenant isolation, three-tier RBAC (SUPER_ADMIN/ADMIN/MEMBER), and TTL-indexed audit logging. Ships Auth0 Organizations for B2B auth, HMAC-signed math CAPTCHA on signup, LangGraph supervisor agents over MongoDB Atlas Vector Search (ada-002 embeddings), LlamaIndex chunking, BullMQ scrape queues on Redis, and super-admin impersonation sessions.",
      technologies: [
        "Next.js",
        "NestJS",
        "TypeScript",
